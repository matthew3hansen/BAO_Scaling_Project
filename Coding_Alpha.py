...
data_list = helper.get_data()

covariance_matrix = helper.get_covariance_matrix()

xi_IRrs, xi_d1d2, xi_d2d2, xi_d1s2, xi_d2s2, xi_s2s2, xi_d1p3 = helper.get_templates()

xi_IRrs_prime, xi_d1d2_prime, xi_d2d2_prime, xi_d1s2_prime, xi_d2s2_prime, xi_s2s2_prime, xi_d1p3_prime = helper.get_templates_deriv()

xi_IRrs_prime2, xi_d1d2_prime2, xi_d2d2_prime2, xi_d1s2_prime2, xi_d2s2_prime2, xi_s2s2_prime2, xi_d1p3_prime2 = helper.get_templates_deriv2()

p1, p2, p3, p4, p5, p6, p7 = helper.get_biases()
...
#Below are just some debugging prints
...
p = p.transpose()
print("p from here", p)
print(np.shape(np.matmul( p, np.array(xi_tensor[radial_bin_l])).reshape(3)))
...
delta_apha = delta_alpha_(p1, p2, p3, p4, p5, p6, p7)
print("Heres alpha: ", delta_apha)
