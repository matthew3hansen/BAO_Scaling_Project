		...
		for j in range(len(alphas)):
			...
			for l in range(len(self.r)):
				for m in range(len(self.r)):
					total += precision[l][m] * (- xi_IRrs_alpha[l] * dmodel_dalpha[m] - xi_IRrs_alpha[m] * dmodel_dalpha[l] + dmodel_dalpha[l] * model[m] + dmodel_dalpha[m] * model[l])
					
					constant_term += precision[l][m] * (- xi_IRrs_alpha[l] * self.xi_IRrs_prime[m] - xi_IRrs_alpha[m] * self.xi_IRrs_prime[l] \
							+ self.xi_IRrs_prime[l] * self.xi_IRrs[m] + self.xi_IRrs_prime[m] * self.xi_IRrs[l])

					linear_term += precision[l][m] * (- xi_IRrs_alpha[l] * self.xi_IRrs_prime2[m] - xi_IRrs_alpha[m] * self.xi_IRrs_prime2[l] + 2 * self.xi_IRrs_prime[l] * self.xi_IRrs_prime[m] \
			...
			- xi_IRrs_alpha[l]
			self.xi_IRrs[m]
			self.xi_IRrs_prime[m]
			self.xi_IRrs_prime2[m]
			- xi_IRrs_alpha[m]
			self.xi_IRrs[l]
			self.xi_IRrs_prime[l]this
			self.xi_IRrs_prime2[l]
			'''

			constant_term = precision[l][m] * (- xi_IRrs_alpha[l] * self.xi_IRrs_prime[m] - xi_IRrs_alpha[m] * self.xi_IRrs_prime[l] \
							+ self.xi_IRrs_prime[l] * self.xi_IRrs[m] + self.xi_IRrs_prime[m] * self.xi_IRrs[l])

			linear_term = precision[l][m] * (- xi_IRrs_alpha[l] * self.xi_IRrs_prime2[m] - xi_IRrs_alpha[l] * self.xi_IRrs_prime2[l] + 2 * self.xi_IRrs_prime[l] * self.xi_IRrs_prime[m] \
							+ self.xi_IRrs_prime2[l] * self.xi_IRrs[m] + self.xi_IRrs_prime2[m] * self.xi_IRrs[l]) * (alphas[j] - 1)
